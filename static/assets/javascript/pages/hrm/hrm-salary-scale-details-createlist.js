    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const salsdtlcale_id = '';
                const search_url = "/apihrm-salaryScale-details-api?salsdtlcale_id=" + salsdtlcale_id;
...
$(function () {
    ...
    function show_edit_form(id) {
        $.ajax({
            url: '/hrm-employee-salary-scale-details-edit/' + id,
            type: 'get',
            dataType: 'json',
            beforeSend: function () {
