    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const id = '';
                const search_url = "/apihrm-empNominee-api?id=" + id;
                table_data = $('#dt-table-list').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'nominee_serial' },
                        { data: 'nominee_name' },
                        { data: 'nominee_father_name' },
                        { data: 'nominee_mother_name' },
                        { data: 'nominee_present_addr' },
                        { data: 'nominee_permanent_addr' },
                        { data: 'nominee_birth_date' },
                        { data: 'country_id' },
                        { data: 'nominee_nid_num' },
                        { data: 'nominee_religion' },
                        { data: 'nominee_blood_group' },
                        { data: 'nominee_mobile_num' },
...
$(function () {
    ...
    function show_edit_form(id) {
        $.ajax({
            url: '/hrm-employee-nominee-edit/' + id,
            type: 'get',
            dataType: 'json',
            beforeSend: function () {
